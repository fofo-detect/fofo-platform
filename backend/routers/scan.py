...
@router.post("/scan/{subscriber_id}", response_model=ScanResponse)
def run_scan(subscriber_id: str):
    settings = get_settings()
    ...
    for candidate in candidates:
        ...
        try:
            ...
            if risk_level in ALERTABLE_RISK_LEVELS and subscriber.data.get("phone"):
                try:
